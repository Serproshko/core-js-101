...
function doRectanglesOverlap(/* rect1, rect2 */) {
  // const arrOne = Array(rect1);
  // const arrTwo = Array(rect2);
  // if (arrOne[1].top < arrOne[0].width || arrTwo[1].top < arrTwo[1].width) {
  //   return true;
  // }
  // return false;
  throw new Error('Not implemented');
...
function getIntervalString(a, b, isStartIncluded, isEndIncluded) {
  if (a > b && isStartIncluded === true && isEndIncluded === true) return `[${b}, ${a}]`;
  if (isStartIncluded === true && isEndIncluded === true) return `[${a}, ${b}]`;
  if (isStartIncluded === false && isEndIncluded === true) return `(${a}, ${b}]`;
  if (isStartIncluded === true && isEndIncluded === false) return `[${a}, ${b})`;
  return `(${a}, ${b})`;
}
...
function isCreditCardNumber(/* ccn */) {
  ...
  // const arrCCN = arr.slice(0, 10).reverse();
  // for (let i = 0; i < arrCCN.length; i += 1) {
  //   arrCCN[i] = Number(arrCCN[i]);
  //   newArr.push(arrCCN[i]);
  // }
...
function getDigitalRoot(num) {
  ...
  if (sum > 9) {
    ...
    return arrDigit.reduce((a, b) => a + b);
  }
  return sum;
}
...
function evaluateTicTacToePosition(position) {
  ...
  || (position[2][0] === 'X' && position[2][1] === 'X' && position[2][2] === 'X')) { return 'X'; }
  if ((position[0][0] === 'X' && position[1][0] === 'X' && position[2][0] === 'X')
  || (position[0][1] === 'X' && position[1][1] === 'X' && position[2][1] === 'X')
  || (position[0][2] === 'X' && position[1][2] === 'X' && position[2][2] === 'X')) { return 'X'; }
  ...
  || (position[2][0] === '0' && position[2][1] === '0' && position[2][2] === '0')) { return '0'; }
  if ((position[0][0] === '0' && position[1][0] === '0' && position[2][0] === '0')
  || (position[0][1] === '0' && position[1][1] === '0' && position[2][1] === '0')
  || (position[0][2] === '0' && position[1][2] === '0' && position[2][2] === '0')) { return '0'; }
  return undefined;
}
